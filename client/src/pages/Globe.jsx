...
const ALL_COUNTRIES = {
  ...
  'Andorra': [42.54, 1.60], 'Angola': [-11.20, 17.87], 'Argentina': [-38.41, -63.61],
  'Armenia': [40.07, 45.04], 'Australia': [-25.27, 133.77], 'Austria': [47.51, 14.55],
  'Azerbaijan': [40.14, 47.57], 'Bahrain': [26.00, 50.55], 'Bangladesh': [23.68, 90.35],
  'Belarus': [53.71, 27.95], 'Belgium': [50.50, 4.46], 'Bolivia': [-16.29, -63.58],
  'Bosnia and Herzegovina': [43.91, 17.67], 'Botswana': [-22.32, 24.68], 'Brazil': [-14.23, -51.92],
  'Bulgaria': [42.73, 25.48], 'Cambodia': [12.56, 104.99], 'Cameroon': [3.86, 11.51],
  'Canada': [56.13, -106.34], 'Chile': [-35.67, -71.54], 'China': [35.86, 104.19],
  'Colombia': [4.57, -74.29], 'Croatia': [45.10, 15.20], 'Cuba': [21.52, -77.78],
  'Czech Republic': [49.81, 15.47], 'Denmark': [56.26, 9.50],
  'Democratic Republic of Congo': [-4.03, 21.75], 'Ecuador': [-1.83, -78.18],
  'Egypt': [26.82, 30.80], 'Ethiopia': [9.14, 40.48], 'Finland': [61.92, 25.74],
  'France': [46.22, 2.21], 'Germany': [51.16, 10.45], 'Ghana': [7.94, -1.02],
  'Greece': [39.07, 21.82], 'Guatemala': [15.78, -90.23], 'Hungary': [47.16, 19.50],
  'India': [20.59, 78.96], 'Indonesia': [-0.78, 113.92], 'Iran': [32.42, 53.68],
  'Iraq': [33.22, 43.67], 'Ireland': [53.41, -8.24], 'Israel': [31.04, 34.85],
  'Italy': [41.87, 12.56], 'Japan': [36.20, 138.25], 'Jordan': [30.58, 36.23],
  'Kazakhstan': [48.01, 66.92], 'Kenya': [0.02, 37.90], 'Kuwait': [29.33, 47.58],
  'Lebanon': [33.85, 35.86], 'Libya': [26.33, 17.22], 'Malaysia': [4.21, 108.96],
  'Mexico': [23.63, -102.55], 'Morocco': [31.79, -7.09], 'Myanmar': [21.91, 95.95],
  'Netherlands': [52.13, 5.29], 'New Zealand': [-40.90, 174.88], 'Nigeria': [9.08, 8.67],
  'North Korea': [40.34, 127.51], 'Norway': [60.47, 8.47], 'Oman': [21.51, 55.92],
  'Pakistan': [30.37, 69.34], 'Palestine': [31.95, 35.23], 'Peru': [-9.18, -75.01],
  'Philippines': [12.87, 121.77], 'Poland': [51.91, 19.14], 'Portugal': [39.39, -8.22],
  'Qatar': [25.35, 51.18], 'Romania': [45.94, 24.96], 'Russia': [61.52, 105.31],
  'Saudi Arabia': [23.88, 45.07], 'Serbia': [44.01, 21.00], 'Singapore': [1.35, 103.81],
  ...
  'Sudan': [12.86, 30.21], 'Sweden': [60.12, 18.64], 'Switzerland': [46.81, 8.22],
  'Syria': [34.80, 38.99], 'Taiwan': [23.69, 120.96], 'Tanzania': [-6.36, 34.89],
  'Thailand': [15.87, 100.99], 'Tunisia': [33.88, 9.53], 'Turkey': [38.96, 35.24],
  'Uganda': [1.37, 32.29], 'Ukraine': [48.37, 31.16], 'United Arab Emirates': [23.42, 53.84],
  'United Kingdom': [55.37, -3.43], 'United States': [37.09, -95.71], 'Uruguay': [-32.52, -55.76],
  'Uzbekistan': [41.37, 64.58], 'Venezuela': [6.42, -66.58], 'Vietnam': [14.05, 108.27],
    ...
    <div style={{ color: 'white' }}>
      ...
      {section === 'historical' && profile.historical?.map((h, i) => (
        <div key={i} style={{ display: 'flex', gap: 12, marginBottom: 12, alignItems: 'flex-start' }}>
          <div style={{ flexShrink: 0, width: 44, height: 44, borderRadius: '50%', background: 'rgba(204,0,0,0.2)', border: '1px solid rgba(204,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700, color: '#CC0000', textAlign: 'center', lineHeight: 1.2 }}>{h.year}</div>
          <div>
    ...
    >
      <style>{`
        @media (min-width: 640px) {
          .globe-country-panel {
            top: 63px !important; bottom: auto !important; left: auto !important;
